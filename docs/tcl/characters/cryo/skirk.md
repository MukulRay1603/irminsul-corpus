<!-- Source: KQM Theorycrafting Library — docs\characters\cryo\skirk.md -->
...
<Image img={require('/img/characters/gacha/Skirk.png')} alt="Skirk's gacha art" />
...
<!-- 
* [Skirk Mains Discord]()
* [Full Skirk Written Guide]()
* [Skirk Quick Guide]()
* [# Minute Video Guide to Skirk]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Skirk.json'
...
<Card item={require('../../evidence/characters/cryo/skirk.md')} />
