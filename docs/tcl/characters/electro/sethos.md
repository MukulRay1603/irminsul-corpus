<!-- Source: KQM Theorycrafting Library — docs\characters\electro\sethos.md -->
...
import charFrames from '@site/src/data/frames/sethos.json'
...
<Card item={require('../../evidence/characters/electro/sethos.md')} />
