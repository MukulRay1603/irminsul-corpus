<!-- Source: KQM Theorycrafting Library — docs\characters\hydro\aino.md -->
...
<Image img={require('/img/characters/gacha/Aino.png')} alt="Aino's gacha art" />
...
<!-- 
* [Aino Mains Discord]()
* [Full Aino Written Guide]()
* [Aino Quick Guide]()
* [# Minute Video Guide to Aino]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Aino.json'
...
<Card item={require('../../evidence/characters/hydro/aino.md')} />
