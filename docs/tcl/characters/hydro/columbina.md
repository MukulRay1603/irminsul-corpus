<!-- Source: KQM Theorycrafting Library — docs\characters\hydro\columbina.md -->
<!-- License: https://github.com/KQM-git/TCL/blob/master/LICENSE -->

---
description: The Moon Maiden born in Nod-Krai, and also the welkin moon returning home.
---

import char from '@site/src/data/characters/Columbina.json'
...
<Image img={require('/img/characters/gacha/Columbina.png')} alt="Columbina's gacha art" />
<blockquote>{frontMatter.description}</blockquote>

## Resources

<!-- 
* [Columbina Mains Discord]()
* [Full Columbina Written Guide]()
* [Columbina Quick Guide]()
* [# Minute Video Guide to Columbina]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Columbina.json'
...
<Card item={require('../../evidence/characters/hydro/columbina.md')} />
