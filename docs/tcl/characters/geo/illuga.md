<!-- Source: KQM Theorycrafting Library — docs\characters\geo\illuga.md -->
<!-- License: https://github.com/KQM-git/TCL/blob/master/LICENSE -->

---
description: Member of the investigation squad, the Nightmare Orioles. The youngest squad leader among the Lightkeepers.
---

import char from '@site/src/data/characters/Illuga.json'
...
<Image img={require('/img/characters/gacha/Illuga.png')} alt="Illuga's gacha art" />
<blockquote>{frontMatter.description}</blockquote>

## Resources

<!-- 
* [Illuga Mains Discord]()
* [Full Illuga Written Guide]()
* [Illuga Quick Guide]()
* [# Minute Video Guide to Illuga]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Illuga.json'
...
<Card item={require('../../evidence/characters/geo/illuga.md')} />
