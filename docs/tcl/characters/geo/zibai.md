<!-- Source: KQM Theorycrafting Library — docs\characters\geo\zibai.md -->
<!-- License: https://github.com/KQM-git/TCL/blob/master/LICENSE -->

---
description: The White Horse Adeptus from Liyue's legends, known as Zibai. The most mysterious figure in Liyue's myths.
---

import char from '@site/src/data/characters/Zibai.json'
...
<Image img={require('/img/characters/gacha/Zibai.png')} alt="Zibai's gacha art" />
...
<!-- 
* [Zibai Mains Discord]()
* [Full Zibai Written Guide]()
* [Zibai Quick Guide]()
* [# Minute Video Guide to Zibai]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Zibai.json'
...
<Card item={require('../../evidence/characters/geo/zibai.md')} />
