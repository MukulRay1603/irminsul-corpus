<!-- Source: KQM Theorycrafting Library — docs\characters\anemo\varka.md -->
<!-- License: https://github.com/KQM-git/TCL/blob/master/LICENSE -->

---
description: Grand Master of the Knights of Favonius. Knight of Boreas, protector of Mondstadt.
---

import char from '@site/src/data/characters/Varka.json'
...
<Image img={require('/img/characters/gacha/Varka.png')} alt="Varka's gacha art" />
...
<!-- 
* [Varka Mains Discord]()
* [Full Varka Written Guide]()
* [Varka Quick Guide]()
* [# Minute Video Guide to Varka]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Varka.json'
...
<Card item={require('../../evidence/characters/anemo/varka.md')} />
