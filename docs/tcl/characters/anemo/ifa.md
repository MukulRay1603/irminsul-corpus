<!-- Source: KQM Theorycrafting Library — docs\characters\anemo\ifa.md -->
<!-- License: https://github.com/KQM-git/TCL/blob/master/LICENSE -->

---
description: A vet from the Flower-Feather Clan who cherishes the life he leads alongside all manner of living things — people, animals, you name it.
---


import char from '@site/src/data/characters/Ifa.json'
...
<Image img={require('/img/characters/gacha/Ifa.png')} alt="Ifa's gacha art" />
...
<!-- 
* [Ifa Mains Discord]()
* [Full Ifa Written Guide]()
* [Ifa Quick Guide]()
* [# Minute Video Guide to Ifa]()
-->
...
<!-- 
import charFrames from '@site/src/data/frames/Ifa.json'
...
<Card item={require('../../evidence/characters/anemo/ifa.md')} />
