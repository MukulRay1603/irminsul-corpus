<!-- Source: KQM Theorycrafting Library — docs\resources\compendiums\README.md -->
...
* [Elemental Skill Particle Production Rate](elemental-skill-particles.md) \(TCL page\)
* [Elemental Gauge Database](elemental-gauges.md) \(TCL page\)
