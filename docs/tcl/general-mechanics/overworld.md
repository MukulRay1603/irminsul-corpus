<!-- Source: KQM Theorycrafting Library — docs\general-mechanics\overworld.md -->
...
* The area in which an Electro crystal can zap a player is [rectangular, with the crystal positioned off-center](/evidence/general-mechanics/overworld#electro-crystal-range).
